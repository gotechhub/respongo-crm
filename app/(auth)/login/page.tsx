...
// GÜVENLİK NOTU (08.09.2026): Bu sayfa kısa süreliğine, kimlik doğrulaması
// olmayan tek-tıkla "test girişi" butonuyla değiştirilmişti
// (/api/test-login, service_role anahtarıyla herkesi info@respongo.com
// olarak oturum açtırıyordu — repo public olduğu için bu herkese açıktı).
// O rota tamamen devre dışı bırakıldı ve gerçek e-posta ile giriş akışı
// geri getirildi. Farklı rollerde test yapmak için Süper Admin panelindeki
// "Master Admin View-As" özelliği kullanılmalı (bkz. system-settings).
